...
# Documented everywhere as the "did it work?" check.
...
# Documented CLI: initialize a manifold.
...
# Documented CLI: see the state.
run_expect "INITIALIZED" "$MANIFOLD_BIN" status

# Documented CLI: the schema is valid.
run_expect "Valid" "$MANIFOLD_BIN" validate

# Constraint templates are advertised as a headline feature.
...
# Documented CLI: the graph renderer and the repo-health check.
