---
description: "Show token budget estimates and model routing recommendations for Manifold phases"
argument-hint: "[<feature-name>] [--phase=<phase>] [--provider=anthropic|openai|google]"
model-routing: haiku
---
