...
* **release:** pin bun to 1.3.11 and revert to linux cross-compile ([6ec78ed](https://github.com/dhanesh/manifold/commit/6ec78edbbfa59bf30ebaa512a6afe4f76644615a))

## [2.31.2](https://github.com/dhanesh/manifold/compare/v2.31.1...v2.31.2) (2026-04-18)

### Bug Fixes

* **release:** skip codesign when bun already signed the mach-o ([a4808f2](https://github.com/dhanesh/manifold/commit/a4808f2685e49bb06cff3f7416334c50b2e9d6d8))
...
* implement prompt eval fixes — 12 issues resolved across 8 phase commands ([2034e88](https://github.com/dhanesh/manifold/commit/2034e88619af32a937db9a959fc4cc82325f84d2))
...
* convert yaml schema examples to json and fix 7 validation failures ([187ccce](https://github.com/dhanesh/manifold/commit/187ccce9fc2145071a7468ad1ff5830d33453f78))
...
* add scope guards to prevent phases from exceeding their mandate ([f0daa7d](https://github.com/dhanesh/manifold/commit/f0daa7d23e36bfb3be275b9873237fef752567c9))

## [2.28.1](https://github.com/dhanesh/manifold/compare/v2.28.0...v2.28.1) (2026-03-30)

### Bug Fixes

* resolve recursive json schema reference warning in cli ([9bda0ec](https://github.com/dhanesh/manifold/commit/9bda0ec123e625e2893fcefd5018dfd4de92b737))

## [2.28.0](https://github.com/dhanesh/manifold/compare/v2.27.1...v2.28.0) (2026-03-27)

### Features

* add 8 constraint enhancements + non-software domain support ([61b7a55](https://github.com/dhanesh/manifold/commit/61b7a55558e66f3282c5fcf4292781bbb2717a50))
...
* consolidate plugin/install duplication via symlinks ([9fb34f8](https://github.com/dhanesh/manifold/commit/9fb34f88b1224f98a554123a8af688e447418857))

## [2.23.0](https://github.com/dhanesh/manifold/compare/v2.22.0...v2.23.0) (2026-02-10)

### Features

* add claude code plugin distribution ([d1ea8a1](https://github.com/dhanesh/manifold/commit/d1ea8a115e3789ff593d01ce88d0cb9268cc3342))
...
* quote yaml descriptions in codex skill.md to handle colons ([1248b86](https://github.com/dhanesh/manifold/commit/1248b8686ba9f0031e65601842261f5a86ce2630))
...
* unescape yaml frontmatter quotes in build-commands parser ([01893e5](https://github.com/dhanesh/manifold/commit/01893e59d08846d50ba1c729825fbaac3cc78b7c))
